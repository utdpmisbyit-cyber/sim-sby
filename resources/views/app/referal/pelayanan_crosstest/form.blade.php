<form id="formPelayanan" class="p-0" style="width:100%;" onsubmit="return false;">
    ...
    <div class="row g-3 p-3">
        ...
        {{-- ── Tgl Periksa & Batas (Kadaluarsa) Kantong ─────────────────── --}}
        <div class="col-md-3">
            <label class="form-label">Tgl Periksa</label>
            <input type="datetime-local" id="inpTglPeriksa" class="form-control">
        </div>

        <div class="col-md-3">
            <label class="form-label">Batas <span class="text-danger">*</span></label>
            <input type="datetime-local" id="inpBatas" class="form-control">
        </div>

        <div class="col-md-3">
            <label class="form-label d-block">Status Kantong</label>
            <div class="mt-2">
                <span id="lblKadaluarsaBadge" class="badge-pill">
        ...
        <div class="col-md-3">
            <label class="form-label">Hasil Referal</label>
        ...
        <div class="col-12 pt-3 border-top">
            <div class="d-flex flex-wrap align-items-center gap-2">
                ...
                <button type="button" class="btn-utd" id="btnUpdateRecord"
                        ...
                        title="Perbarui data referal yang sedang diedit">
                    <i class="bi bi-save me-1"></i> Update
                </button>

                {{-- Tambah kantong (hasil scan ATAU input manual) ke daftar pending --}}
                <button type="button" class="btn-utd-outline" id="btnAddToPending"
                        style="border-color:#aaa; color:#555;" 
                        title="Tambah kantong ke daftar pending (hasil scan atau input manual)">
