...
<div class="content flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-row justify-content-between align-items-center mb-6">
        ...
        <div>
            <a href="{{ route('unit.pengiriman_sample.index') }}" class="btn btn-sm btn-primary fw-bold">
...
/* ══════════════════════════════════════
   CONFIG & STATE
   ══════════════════════════════════════ */
const ROUTE_INDEX    = "{{ route('unit.riwayat_pengiriman_sample') }}";
const ROUTE_SHOW     = "{{ url('/unit/pengiriman_sample') }}"; // URL base to fetch detail
