...
@section('title')
    Penerimaan Kantong – Unit Transfusi Darah
@endsection
...
/* ═══════════════════════════════════════
   CONFIG
═══════════════════════════════════════ */
const ROUTE_SCAN    = "{{ route('unit.penerimaan.scan') }}";
const ROUTE_JUMLAH  = "{{ route('unit.penerimaan.get_jumlah') }}";
const ROUTE_STORE   = "{{ route('unit.penerimaan.store') }}";
const ROUTE_HISTORY = "{{ route('unit.penerimaan.index') }}"; 
const ROUTE_SEARCH_KELUAR      = "{{ route('unit.penerimaan.search_no_keluar') }}";
const ROUTE_SEARCH_PERMINTAAN  = "{{ route('unit.penerimaan.search_no_permintaan') }}";
const ROUTE_KANTONG_BY_KELUAR  = "{{ route('unit.penerimaan.kantong_by_no_keluar') }}";
const ROUTE_KANTONG_BY_PERM    = "{{ route('unit.penerimaan.kantong_by_no_permintaan') }}";
