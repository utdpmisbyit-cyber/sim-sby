            ...
            <div class="card-body">
                <div class="d-flex flex-row justify-content-between align-items-center">
                    <div class="d-flex flex-column">
                        <h1 class="d-flex align-items-center my-1"><span class="text-dark fw-bold fs-1">Data Donor</span></h1>
                        @include('layouts._breadcrumb')
                    </div>
                    <button type="button" onclick="info()" class="btn btn-sm btn-primary fw-bold border-0 fs-7">Tambah Donor</button>
                </div>
...
@push('scripts')
    <script>
       ...
       let display_modal_info = (item) => {
          ...
          setTimeout(() => {
        // initSelect2Ajax() sudah ada di _form.blade, tapi
        // karena di-inject via AJAX, jalankan ulang dari sini:
        if (typeof initSelect2Ajax === 'function') initSelect2Ajax();
    }, 150);
        }
