...
<div class="fp-header">
    ...
    <div class="ms-auto">
        <a href="{{ route('crossmatch.permintaan_fpup.create') }}" class="btn-fp btn-primary">
...
<div class="container-fluid px-4 py-4">
    ...
    {{-- Filter --}}
    <form method="GET" action="{{ route('crossmatch.permintaan_fpup.index') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-row" style="justify-content:center;">
                                <a href="{{ route('crossmatch.permintaan_fpup.show', $row) }}"
                                   class="btn-fp btn-sm btn-teal" title="Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('crossmatch.permintaan_fpup.edit', $row) }}"
                                   class="btn-fp btn-sm btn-amber" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="{{ route('crossmatch.permintaan_fpup.barcode', $row->id) }}"
                                target="_blank"
                                ...
                                <form method="POST"
                                      action="{{ route('crossmatch.permintaan_fpup.destroy', $row) }}"
                    ...
                    <tr class="empty-row">
                        <td colspan="11">
                            ...
                            <a href="{{ route('crossmatch.permintaan_fpup.create') }}"
