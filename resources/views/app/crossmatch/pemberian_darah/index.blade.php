...
@section('title', 'Pemberian Darah Crossmatch')
    ...
    <div class="card-bd">
        ...
        <div class="page-header d-flex justify-content-between align-items-center">
            <div>
                ...
                <strong>Pemberian Darah Crossmatch</strong>
            </div>
            <a href="{{ route('crossmatch.pemberian_darah.create') }}" class="btn btn-sm btn-light fw-semibold">
        ...
        <div class="p-3">
            ...
            {{-- ── Filter ────────────────────────────────────────── --}}
            <form method="GET" action="{{ route('crossmatch.pemberian_darah.index') }}" class="filter-bar">
                <div class="row g-2 align-items-end">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="{{ route('crossmatch.pemberian_darah.index') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <table class="table table-bordered table-sm table-bd mb-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('crossmatch.pemberian_darah.show', $row) }}"
                                   class="btn btn-sm btn-outline-info btn-icon" title="Detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('crossmatch.pemberian_darah.edit', $row) }}"
