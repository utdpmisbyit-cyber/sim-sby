...
<div class="container-fluid py-3">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('crossmatch.pengembalian_darah.index') }}" class="btn btn-sm btn-light" style="font-size:.78rem">
    ...
    <form method="POST"
          action="{{ $isEdit
              ? route('crossmatch.pengembalian_darah.update', $pengembalian)
              : route('crossmatch.pengembalian_darah.store') }}"
          id="mainForm">
        @csrf
        ...
        <div class="form-footer">
            <a href="{{ route('crossmatch.pengembalian_darah.index') }}" class="btn-cancel">
...
<script>
const ROUTES = {
    scanFpup:    "{{ route('crossmatch.pengembalian_darah.scan_fpup') }}",
    scanStock:   "{{ route('crossmatch.pengembalian_darah.scan_stock') }}",
    scanPetugas: "{{ route('crossmatch.pengembalian_darah.scan_petugas') }}",
};
