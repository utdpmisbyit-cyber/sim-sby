...
<div class="container-fluid py-3">
    ...
    <div class="action-bar">
        <a href="{{ route('crossmatch.pengembalian_darah.index') }}" class="btn-back">
            <i class="fas fa-arrow-left"></i> Kembali
        </a>
        <a href="{{ route('crossmatch.pengembalian_darah.edit', $pengembalian) }}" class="btn-edit">
        ...
        <form id="del-{{ $pengembalian->id }}"
              action="{{ route('crossmatch.pengembalian_darah.destroy', $pengembalian) }}"
