            ...
            <div class="d-flex flex-row justify-content-between align-items-center">
                <div class="d-flex flex-column">
                    <h1 class="d-flex align-items-center my-1">
                        <span class="text-dark fw-bold fs-1">Permintaan Supplier</span>
                    </h1>
...
let selected_page = 1, _token = '{{ csrf_token() }}', base_url = '{{ route('inventory.permintaan_supplier.index') }}', params_url = '{{ $params ?? '' }}';
