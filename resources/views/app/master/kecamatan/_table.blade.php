<div class="table-responsive">
    <table class="table align-middle table-row-dashed table-hover fs-7 table-sm">
        ...
        <tbody>
        @php($no = 1)
        @if($kecamatans instanceof \Illuminate\Pagination\LengthAwarePaginator)
            @php($no = (($kecamatans->currentPage()-1) * $kecamatans->perPage()) + 1)
        @endif
...
@if($kecamatans instanceof \Illuminate\Pagination\LengthAwarePaginator)
    {{ $kecamatans->links('vendor.pagination.custom') }}
@endif
