...
return new class extends Migration
{
    ...
    {
        Schema::create('pengembalian_darah_crossmatch', function (Blueprint $table) {
            $table->id();
         ...
         Schema::create('pengembalian_darah_crossmatch_detail', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('pengembalian_id')
                  ->references('id')
                  ->on('pengembalian_darah_crossmatch')
                  ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('pengembalian_darah_crossmatch_detail');
        Schema::dropIfExists('pengembalian_darah_crossmatch');
    }
};