...
class PengembalianDarahReferalDetail extends Model
{
    use HasFactory;

    protected $table = 'pengembalian_darah_referal_detail';
    ...
    {
        return $this->belongsTo(PengembalianDarahReferal::class, 'pengembalian_id');
    }
