...
class PelayananCrosstestReferal extends Model
{
    use SoftDeletes;

    protected $table = 'pelayanan_crosstest_referal';
    ...
    {
        return $this->belongsTo(CrossTestReferal::class, 'cross_test_id');
    }

    public function permintaanFpup(): BelongsTo
    {
        return $this->belongsTo(PermintaanFpupReferal::class, 'permintaan_fpup_id');
    }
