...
class PelayananDarahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('app.finance.kasir.pelayanan_darah.index',
    ...
    public function show(Request $request, PelayananDarah $pelayananDarah)
    {
        ...
        return redirect()->route('app.finance.kasir.pelayanan_darah.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('app.finance.kasir.pelayanan_darah.index')
     ...
     * (harga_satuan sudah otomatis terisi dari service_costs) + jenis_biaya list.
     */
    ...
    /**
     * Lookup harga_satuan dari service_costs berdasarkan Jenis RS (Pemerintah/Swasta)
     * + Jenis Biaya. Dipakai saat user mengubah dropdown "Jenis Biaya" atau kolom
     * "Jenis RS" secara manual (bukan dari hasil scan, yang sudah dihitung di backend).
     */
    public function hargaSatuan(Request $request)
    {
        $request->validate([
            'jenis_rs'  => 'nullable|string',
            'jns_biaya' => 'required|string',
        ]);

        $harga = $this->service->getHargaSatuan($request->jenis_rs, $request->jns_biaya);

        return response()->json(['harga_satuan' => $harga]);
    }
