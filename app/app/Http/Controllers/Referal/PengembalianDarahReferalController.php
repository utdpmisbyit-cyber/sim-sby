...
use App\Services\PengembalianDarahReferalService;
...
class PengembalianDarahReferalController extends Controller
{
    public function __construct(
        protected PengembalianDarahReferalService $service
    ) {}
    ...
    public function index(Request $request): View
    {
        ...
        return view('app.referal.pengembalian_darah.index', compact('list', 'filters'));
    }

    public function create(): View
    {
        $nomorBaru = PengembalianDarahReferal::generateNomor();
        return view('app.referal.pengembalian_darah.form', [
            'pengembalian' => null,
            'nomorBaru'    => $nomorBaru,
            'isEdit'       => false,
        ]);
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()
                ->route('referal.pengembalian_darah.index')
    ...
    public function show(PengembalianDarahReferal $pengembalianDarah): View
    {
        $pengembalianDarah->load('details');
        return view('app.referal.pengembalian_darah.show', ['pengembalian' => $pengembalianDarah]);
    }

    public function edit(PengembalianDarahReferal $pengembalianDarah): View
    {
        $pengembalianDarah->load('details');
        return view('app.referal.pengembalian_darah.form', [
    ...
    public function update(Request $request, PengembalianDarahReferal $pengembalianDarah): RedirectResponse
    {
        $validated = $request->validate([
            'tanggal_kembali'          => 'required|date',
            'no_fpup'                  => 'nullable|string|max:50',
    ...
    public function destroy(PengembalianDarahReferal $pengembalianDarah): RedirectResponse
    {
        try {
