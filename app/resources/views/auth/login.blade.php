            ...
            <div class="card card-flush w-lg-650px py-5 shadow rounded-4">
                <div class="card-body py-15 py-lg-20">
                    <form action="{{ route('login.process') }}" method="post">
                        ...
                        <h1 class="fw-bolder text-gray-900 mb-2">Login Account</h1>
                        <div class="fs-6 fw-semibold text-gray-500 mb-10">Login with your account to start using {{ env('APP_NAME') }}</div>

                        <div class="d-flex flex-column mx-lg-20 mb-6">
                            <x-io-input name="email" type="text" caption="Username" :value="old('email')" placeholder="Email" :viewtype="2" />
