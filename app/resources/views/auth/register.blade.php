            ...
            <div class="card card-flush w-lg-650px py-5 shadow rounded-4">
                <div class="card-body py-15 py-lg-20">
                    <form action="{{ route('register.process') }}" method="post">
                        ...
                        <h1 class="fw-bolder text-gray-900 mb-2">Register Account</h1>
                        ...
                        <div class="d-flex flex-column mx-lg-20 mb-6">
                            <x-io-input name="name" caption="Name" :value="old('name')" placeholder="Your Name" :viewtype="2" />
                            <x-io-input name="company_name" caption="Company Name" :value="old('company_name')" placeholder="Company or Organisation Name" :viewtype="2" />
                            <x-io-input name="email" type="email" caption="Email" :value="old('email')" placeholder="Active Email" :viewtype="2" />
                            ...
                            <div class="d-flex flex-row justify-content-between align-items-center">
                                <div class="d-flex flex-row align-items-start justify-content-between mt-3">
                        ...
                        <div class="d-flex flex-column gap-3 mx-lg-20 mb-6">
                            <button type="submit" class="btn btn-primary ps-8">
                                Register
                                <i class="ki-duotone ki-right fs-3 me-0 ms-1"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>
                            </button>
                            <hr>
                            <a href="{{ route('login') }}" class="text-dark pe-4">
                                <i class="ki-duotone ki-lock fs-3 me-1 ms-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>
                                Login
                            </a>
                        </div>
                    </form>
