...
<div class="container-fluid px-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 mt-3">
        ...
        <a href="{{ route('aftap.pengembalian_kantong.create') }}" class="btn btn-primary">
        ...
        <div class="card-body py-2">
            <form method="GET" action="{{ route('aftap.pengembalian_kantong.index') }}" class="row g-2 align-items-end">
                ...
                <div class="col-sm-2 d-flex gap-1">
                    ...
                    <a href="{{ route('aftap.pengembalian_kantong.index') }}"
                        ...
                        <tr>
                            ...
                            <td class="text-center pe-3">
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <a href="{{ route('aftap.pengembalian_kantong.edit', $row->id) }}"
...
document.querySelectorAll('.btn-hapus').forEach(btn => {
    btn.addEventListener('click', function () {
        if (confirm(`Hapus pengembalian "${this.dataset.no}"? Data tidak dapat dipulihkan.`)) {
            ...
            form.action = `{{ url('aftap/pengembalian_kantong') }}/${this.dataset.id}`;
            form.submit();
        }
    });
});
...
function openDetail(id) {
    ...
    editBtn.href = `{{ url('aftap/pengembalian_kantong') }}/${id}/edit`;
    modal.show();

    fetch(`{{ url('aftap/pengembalian_kantong') }}/${id}`, {
