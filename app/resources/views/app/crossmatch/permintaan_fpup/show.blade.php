...
<div class="fp-header">
    ...
    <div class="ms-auto">
        <a href="{{ route('crossmatch.permintaan_fpup.edit', $fpup) }}" class="btn-fp btn-amber">
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="fpup-bar">
        ...
        <div>
            <form method="POST"
                  action="{{ route('crossmatch.permintaan_fpup.destroy', $fpup) }}"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const UPDATE = '{{ route("crossmatch.permintaan_fpup.update-status", $fpup) }}';
