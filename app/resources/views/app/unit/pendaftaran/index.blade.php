...
@section('title')
    Pendaftaran - Unit Transfusi Darah -
@endsection
                ...
                <div class="d-flex flex-row justify-content-between align-items-center">
                    <div class="d-flex flex-column">
                        <h1 class="d-flex align-items-center my-1">
                            <span class="text-dark fw-bold fs-1">Pendaftaran Pasien</span>
                        </h1>
...
@push('scripts')
    <script>
        ...
        let base_url = '{{ route('unit.pendaftaran.index') }}', donor_url = '{{ route('unit.donor.index') }}';
        let search_result = [];
...
let kirim_wa = () => {
    ...
    let pesan = `*UNIT TRANSFUSI DARAH*\n\n` +
