...
@php
    ...
    $formAction  = $isEdit
        ? route('unit.pengembalian_kantong.update', $pengembalian->id)
        : route('unit.pengembalian_kantong.store');
...
<div class="container-fluid px-4">
    ...
    <div class="d-flex align-items-center gap-2 mb-3 mt-3">
        <a href="{{ route('unit.pengembalian_kantong.index') }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('unit.pengembalian_kantong.index') }}" class="btn btn-outline-secondary">
...
(function () {
    ...
    const SCAN_URL        = '{{ route('unit.pengembalian_kantong.scan_kantong') }}';
