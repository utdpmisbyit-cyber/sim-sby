...
/* ══════════════════════════════════════
   CONFIG
══════════════════════════════════════ */
const ROUTE_INDEX    = "{{ route('unit.pengiriman_sample.index') }}";
const ROUTE_SCAN     = "{{ route('unit.pengiriman_sample.scan') }}";
const ROUTE_STORE    = "{{ route('unit.pengiriman_sample.store') }}";
const ROUTE_KIRIM    = "{{ route('unit.pengiriman_sample.kirim_fpd', ':id') }}"; // ← baru
