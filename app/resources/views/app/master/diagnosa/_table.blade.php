<div class="table-responsive">
    <table class="table align-middle table-row-dashed table-hover fs-7 table-sm">
        ...
        <tbody>
        @php($no = 1)
        @if($diagnosas instanceof \Illuminate\Pagination\LengthAwarePaginator)
            @php($no = (($diagnosas->currentPage()-1) * $diagnosas->perPage()) + 1)
        @endif
...
@if($diagnosas instanceof \Illuminate\Pagination\LengthAwarePaginator)
    {{ $diagnosas->links('vendor.pagination.custom') }}
@endif
