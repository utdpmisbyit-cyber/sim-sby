...
@section('title', 'Pengembalian Darah Referal')
...
<div class="container-fluid py-3">
    ...
    <div class="page-header">
        <h4>
            ...
            Pengembalian Darah Referal
        </h4>
        <a href="{{ route('referal.pengembalian_darah.create') }}" class="btn btn-sm btn-light fw-semibold" style="font-size:.8rem">
    ...
    <div class="filter-card">
        <form method="GET" action="{{ route('referal.pengembalian_darah.index') }}" id="filterForm">
            <div class="row align-items-end g-2">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('referal.pengembalian_darah.index') }}" class="btn btn-outline-secondary btn-sm px-3" style="font-size:.8rem">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('referal.pengembalian_darah.show', $row) }}" class="btn-act btn-act-show">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('referal.pengembalian_darah.edit', $row) }}" class="btn-act btn-act-edit">
                            ...
                            <form id="del-{{ $row->id }}"
                                  action="{{ route('referal.pengembalian_darah.destroy', $row) }}"
