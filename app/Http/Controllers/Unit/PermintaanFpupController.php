...
class PermintaanFpupController extends Controller
{
    ...
    private string $view = 'app.unit.bank_darah.permintaan_fpup';
    ...
    public function barcode($id)
    {
        ...
        return view(
            'app.unit.bank_darah.permintaan_fpup.barcode',
            compact('fpup')
        );
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('unit.bank_darah.permintaan_fpup.show', $fpup)
    ...
    {
        $fpup = $permintaan_fpup->load('details');
    ...
    public function destroy(PermintaanFpup $permintaan_fpup)
    {
        ...
        return redirect()
            ->route('unit.bank_darah.permintaan_fpup.index')
    ...
    public function searchRs(Request $request)
    {
        ...
        return response()->json($rows->map(function ($r) {
            return [
                'kode_rs'       => $r->kode,
                'nama_rs'       => $r->nama,
                'jenis_rs'      => '',          // tidak ada di tabel, isi manual
                'kategori_rs'   => '',          // tidak ada di tabel, isi manual
