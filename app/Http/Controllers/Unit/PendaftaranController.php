...
class PendaftaranController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.unit.pendaftaran.index', compact('params','steps'));
    }
        public function search(Request $request)
    {
       ...
       $paramsLogDonor = [
        ...
        return view('app.unit.pendaftaran._table', compact('log_donors', 'steps', 'count_steps','donors'));
    }
        public function search_donor(Request $request)
    {
        ...
        return view('app.unit.pendaftaran._table_donor', compact('donors'));
    }
 
    public function create()
    {
        $donor = null;
        return view('app.unit.donor._form', $this->view_data($donor));
    }
