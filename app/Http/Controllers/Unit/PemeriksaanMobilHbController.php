...
class PemeriksaanMobilHbController extends Controller
{
    ...
    {
        return view('app.mobil_unit.pemeriksaan_mobil_hb.index');
    }
    ...
    public function search(Request $request)
    {
        ...
        $pemeriksaan_mobil_hbs = $this->pemeriksaanHbService->search(
            array_merge($request->all(), [
                'with' => ['donor', 'dokter']
            ]),
        );
        return view('app.mobil_unit.pemeriksaan_mobil_hb._table', compact('pemeriksaan_mobil_hbs'));
    }

    public function edit($id)
    {
        $pemeriksaan_mobil_hb = $this->pemeriksaanHbService->find($id);
        return view('app.mobil_unit.pemeriksaan_mobil_hb._info', compact('pemeriksaan_mobil_hb', 'id'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $pemeriksaan_mobil_hb = $this->pemeriksaanHbService->update($request->all(), $id);
        $status = $request->input('status') ?? '';
        if ($status === 'Rejected') {
            $this->logDonorService->update(['step' => 'Rejected'], $pemeriksaan_mobil_hb->log_donor_id);
        } else {
            $log_donor = $this->logDonorService->update([
                'step' => 'Aftap'], $pemeriksaan_mobil_hb->log_donor_id);
    ...
    public function log_donor_search(Request $request)
    {
        ...
        return view('app.mobil_unit.pemeriksaan_mobil_hb.log_donor._table', compact('log_donors'));
    }
    ...
    public function log_donor_show($id)
    {
        try {
            ...
            return view('app.unit.pemeriksaan_mobil_hb.log_donor._info', compact('log_donor'));
