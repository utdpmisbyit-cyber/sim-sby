...
class PemeriksaanKesehatanController extends Controller
{
    ...
    {
        return view('app.unit.pemeriksaan_kesehatan.index');
    }
...
public function assign_ruangan(Request $request, $id)
{
    ...
    public function search(Request $request)
    {
        ...
        return view('app.unit.pemeriksaan_kesehatan._table', compact('pemeriksaan_dokters'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('app.unit.pemeriksaan_kesehatan._info', compact('pemeriksaan_dokter', 'id', 'data_kuisioner', 'questions'));
    }
    ...
    public function log_donor_search(Request $request)
    {
        ...
        return view('app.unit.pemeriksaan_kesehatan.log_donor._table', compact('log_donors'));
    }
    ...
    public function log_donor_show($id)
{
    ...
    return view(
        'app.unit.pemeriksaan_kesehatan.log_donor._info',
        compact(
            'log_donor',
            'total',
            'dipanggil',
