...
use App\Services\PelayananCrosstestReferalService;
use Illuminate\Http\Request;
use Illuminate\Validation\Rule;

class PelayananCrosstestReferalController extends Controller
{
    public function __construct(protected PelayananCrosstestReferalService $service)
    {
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('app.referal.pelayanan_crosstest.index', [
            'pelayananList' => $pelayananList,
            'filters'       => $filters,
        ]);
    }

    public function show(PelayananCrosstestReferal $pelayananCrosstest)
    {
    ...
    public function update(Request $request, PelayananCrosstestReferal $pelayananCrosstest)
    {
        $data = $this->validateData($request);
    ...
    public function destroy(PelayananCrosstestReferal $pelayananCrosstest)
    {
    ...
    public function scanPetugas(Request $request)
{
    ...
    protected function validateData(Request $request): array
    {
        return $request->validate([
            'cross_test_id'      => ['required', 'integer', 'exists:cross_tests_referal,id'],
            'permintaan_fpup_id' => ['required', 'integer', 'exists:permintaan_fpup_referal,id'],
