...
return new class extends Migration {
    ...
    {
        Schema::create('pengembalian_darah_external', function (Blueprint $table) {
            $table->id();
            $table->string('no_pengembalian')->unique();
            $table->date('tgl_pengembalian');
            $table->string('tujuan_darah')->nullable();
        ...
        Schema::create('pengembalian_darah_external_detail', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('pengembalian_id')
                  ->references('id')
                  ->on('pengembalian_darah_external')
                  ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('pengembalian_darah_external_detail');
        Schema::dropIfExists('pengembalian_darah_external');
    }
};