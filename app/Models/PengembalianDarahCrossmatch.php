...
class PengembalianDarahCrossmatch extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'pengembalian_darah_crossmatch';
    ...
    {
        return $this->hasMany(PengembalianDarahCrossmatchDetail::class, 'pengembalian_id');
    }
    ...
    /**
     * Generate nomor pengembalian otomatis: PKB-YYYYMM-XXXX
     */
    public static function generateNomor(): string
    {
        $prefix = 'PKB-' . now()->format('Ym') . '-';
